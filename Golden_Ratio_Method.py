...
for k in range(N):
    print("k:", k+1, " x1:", round(x1, 5), " x2:", round(x2, 5), " f(x1):", round(function(x1), 5), " f(x2):",round(function(x2), 5))
...
print("LAST:x_root:",round(result,5)," f: ",round(function(result),5)," f':",round(function_derivative(result),5))
